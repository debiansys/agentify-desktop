...
test('browser-identity: buildChromeUserAgent mirrors chrome + platform', () => {
  const ua = buildChromeUserAgent({ platform: 'win32', chromeVersion: '123.45.6.7', runtime: { platform: 'linux', versions: { chrome: '99.0.0.0' } } });
...
test('browser-identity: buildChromeClientHints sets chrome major version', () => {
  const hints = buildChromeClientHints({ platform: 'darwin', chromeVersion: '124.0.1.2', runtime: { platform: 'linux', versions: { chrome: '99.0.0.0' } } });
